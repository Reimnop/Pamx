...
using Pamx.Prefabs;
using Pamx.Serialization.Converters.Editor;
using Pamx.Serialization.Converters.Events;
using Pamx.Serialization.Converters.Keyframes;
using Pamx.Serialization.Converters.Objects;
using Pamx.Serialization.Converters.Parallax;
using Pamx.Serialization.Converters.Prefabs;
...
[JsonSourceGenerationOptions(
    ...
    [
        ...
        typeof(BpmSnapTypeConverter),
        
        typeof(ParallaxObjectConverter),
